...
my $mm_xmlns_uri = 'http://www.13cflux.net/fluxml';
my $mm_xmlns_mathml_uri = 'http://www.w3.org/1998/Math/MathML';
...
open(FH, "sort mm_constants.txt | uniq | tee mm_constants.new |");
open(OFH, ">MMUnicodeConstants.h");
open(OFC, ">MMUnicodeConstants.cc");

print OFH <<END;
#ifndef MMUNICODECONSTANTS_H
#define MMUNICODECONSTANTS_H

#include <xercesc/util/XMLUniDefs.hpp>

/* Diese Datei wurde automatisch von einem Script generiert.
 * Nicht bearbeiten - stattdessen die Datei mm_constants.txt
...
rename "mm_constants.new", "mm_constants.txt";
print "\n";
